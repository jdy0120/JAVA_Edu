...
class CalendarEx1 {
	public static void main(String[] args) {
		...
		// static 메소드인 getInstance()를 통해 날짜 및 시간 인스턴스 생성
		...
		System.out.println("달의 몇 일 : " +	today.get(Calendar.DATE));
		// DATE와 DAY_OF_MONTH는 동일한 값을 리턴
		System.out.println("달의 몇 일 : " +	today.get(Calendar.DAY_OF_MONTH));
		System.out.println("해의 몇 일 : " +	today.get(Calendar.DAY_OF_YEAR));
		System.out.println("요일(1-7, 1:일요일) : " +	
			today.get(Calendar.DAY_OF_WEEK));
		System.out.println("달의 몇 째 요일 : " +	
