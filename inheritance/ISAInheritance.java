...
// Notebook클래스에서는 Computer의 기능 모두 사용할 수 있으므로 Notevook에서만 필요한 기능을 구현하면 됨
	int battery;
...
// Notevook을 상속받음으로써 Notebook의 상위클래스인 Computer의 기능까지 Tablet에서 사용할 수 있음
// 즉, Computer의 계산기능(calculate())과 Notebook의 휴대기능(movingCal())을 모두 Tavlet에서 사용가능
	String regPen;
